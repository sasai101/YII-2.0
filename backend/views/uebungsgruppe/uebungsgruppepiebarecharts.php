...
$this->title = $model->tutorMarterikelNr->marterikelNr->Vorname." ".$model->tutorMarterikelNr->marterikelNr->Nachname;
$this->params['breadcrumbs'][] = ['label' => 'Tutor', 'url' => ['tutor/index']];
$this->params['breadcrumbs'][] = ['label' => 'view', 'url' => ['tutor/view', 'id'=>$model->Tutor_MarterikelNr]];
