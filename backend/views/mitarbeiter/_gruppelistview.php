		...
		<div class="col-md-12">
			<div class="panel panel-default">
                ...
                <div class="panel-body">
        			...
        			<!-- Korrektor -->
        			<div>
        				&nbsp Tutor: <?php $name = $model->tutorMarterikelNr->marterikelNr->Vorname." ".$model->tutorMarterikelNr->marterikelNr->Nachname?>
        				<b><?= Html::a($name, ['tutor/view', 'id'=>$model->tutorMarterikelNr->MarterikelNr]) ?></b>
        			</div>
                </div>
            </div>
